...
public class TelaTermosCond extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Tela Termos e Condicoes de Uso");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/TelaTermosCond.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new TelaTermosCond().setVisible(true));
    }
